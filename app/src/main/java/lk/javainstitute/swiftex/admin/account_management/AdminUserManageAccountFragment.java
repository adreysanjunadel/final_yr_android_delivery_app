...
public class AdminUserManageAccountFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button updateUserDetailsButton = binding.updateUserDetailsButton;
        Button updateUserAddressButton = binding.updateUserAddressButton;
        Button blockUserButton = binding.blockUserButton;
        Button deleteUserButton = binding.deleteUserButton;
        updateUserDetailsButton.setVisibility(GONE);
        updateUserAddressButton.setVisibility(GONE);
