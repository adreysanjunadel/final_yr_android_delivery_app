...
public class AdminExistingDriverFragment extends Fragment {

    private FragmentAdminManageDriverBinding binding;
    private boolean isDriverDetailsCollapsed;
    private boolean isVehcleDetailsCollapsed;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button manageDriverCreateDriverButton = binding.manageDriverCreateDriverButton;
        manageDriverCreateDriverButton.setVisibility(GONE);

        Button manageDriversAddVehicleDetailsButton = binding.manageDriversAddVehicleDetailsButton;
        manageDriversAddVehicleDetailsButton.setVisibility(GONE);
        ...
        view.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                manageDriverVehicleDetailsCollapsible.setOnClickListener(v->{
                    ...
                    isVehcleDetailsCollapsed = !isVehcleDetailsCollapsed;
                });
            }
        });
    ...
    private void fetchVehicleType(String selectedVehicleModelId) {
        new Thread(() -> {
            try {
                ...
                RequestBody requestBody = RequestBody.create(selectedVehicleModelId, MediaType.parse("application/json"));
                Request request = new Request.Builder()
